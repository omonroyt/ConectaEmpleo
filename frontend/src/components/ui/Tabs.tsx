  ...
  return (
    <div className={className}>
      <div
        ...
        className="inline-flex gap-1 rounded-pill bg-surface-soft p-1"
      >
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "min-h-9 rounded-pill px-4 text-sm font-medium transition-colors duration-fast ease-standard",
                "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-2",
                selected ? "bg-primary text-white" : "text-text-secondary hover:text-text-primary",
              )}
            >
              {item.label}
            </button>
